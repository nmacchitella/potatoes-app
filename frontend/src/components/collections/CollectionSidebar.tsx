...
interface CollectionSidebarProps {
  collections: Collection[];  // Includes both own and partner collections
...
export default function CollectionSidebar({
  ...
  // Separate own collections from partner collections
  const ownCollections = collections.filter(c => !c.owner);
  const partnerCollections = collections.filter(c => !!c.owner);
